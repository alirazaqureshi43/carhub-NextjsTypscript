            ...
            leaveTo="opacity-0 scale-95">
                <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh]
                 ...
                 text-left shadow-xl transition-all flex flex-col gap-5 p-6'>
                    ...
                    top-2 bg-primary-blue-100 rounded-full right-2 z-10 w-fit'>
                    ...
                    <div className="flex flex-1 flex-col gap-3">
                        ...
                        <div className="flex gap-3">
                            <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-r-lg">
                        <Image src='/hero.png' fill priority alt='car model' className="object-contain"/>
                            </div>
                            <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-r-lg">
                        <Image src='/hero.png' fill priority alt='car model' className="object-contain"/>
                   ...
                   <h2 className="font-semibold text-xl capitalize">{car.make} {car.model}</h2>
                    ...
                    <div className="flex flex-wrap mt-3 gap-4 car-detail-div">
                        {
